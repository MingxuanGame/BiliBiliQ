...
class Config(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        bottom_text_cover: builtins.str = ...,
        bottom_text_url: builtins.str = ...,
        top_items: collections.abc.Iterable[global___EntranceShow]
        | None = ...,
        head_image: builtins.str = ...,
        page_items: collections.abc.Iterable[global___EntranceShow]
        | None = ...,
        hit: builtins.int = ...,
    ) -> None: ...
    def ClearField(
...
class PopularReply(google.protobuf.message.Message):
    ...
    def items(
        ...
        bilibili.app.card.v1.card_pb2.Card
    ]:
        """卡片列表"""
    @property
    ...
    def __init__(
        self,
        *,
        items: collections.abc.Iterable[bilibili.app.card.v1.card_pb2.Card]
        | None = ...,
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "config", b"config", "items", b"items", "ver", b"ver"
        ],
    ) -> None: ...
