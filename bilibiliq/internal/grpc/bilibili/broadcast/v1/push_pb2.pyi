...
class _LinkTypeEnumTypeWrapper(
...
class PushMessageResp(google.protobuf.message.Message):
    ...
    class _BizEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            PushMessageResp._Biz.ValueType
        ],
        builtins.type,
    ):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _TypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            PushMessageResp._Type.ValueType
        ],
        builtins.type,
    ):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _PositionEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            PushMessageResp._Position.ValueType
        ],
        builtins.type,
    ):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def __init__(
        ...
        *,
        ...
        expire: builtins.int = ...,
        taskid: builtins.str = ...,
        page_blackList: collections.abc.Iterable[global___PageBlackList]
        | None = ...,
...
class TargetResource(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        Type: global___LinkType.ValueType = ...,
        Resource: collections.abc.Mapping[builtins.str, builtins.str]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "Resource", b"Resource", "Type", b"Type"
        ],
    ) -> None: ...
