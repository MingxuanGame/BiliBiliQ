...
class SubscribeReq(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        target_paths: collections.abc.Iterable[global___TargetPath]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class TargetPath(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["subs", b"subs"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["key", b"key", "subs", b"subs"],
    ) -> None: ...
...
class VegaFrame(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "body", b"body", "options", b"options", "sub_biz", b"sub_biz"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
