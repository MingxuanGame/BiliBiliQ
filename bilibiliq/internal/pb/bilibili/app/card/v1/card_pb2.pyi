...
class Card(google.protobuf.message.Message):
    ...
    def large_cover_v1(self) -> bilibili.app.card.v1.single_pb2.LargeCoverV1:
        """"""
    @property
    def three_item_all_v2(
        self,
    ) -> bilibili.app.card.v1.single_pb2.ThreeItemAllV2:
        """"""
    @property
    ...
    def large_cover_v4(self) -> bilibili.app.card.v1.single_pb2.LargeCoverV4:
        """"""
    @property
    def popular_top_entrance(
        self,
    ) -> bilibili.app.card.v1.single_pb2.PopularTopEntrance:
        """热门列表顶部按钮"""
    @property
    def rcmd_one_item(self) -> bilibili.app.card.v1.single_pb2.RcmdOneItem:
        """"""
    @property
    def small_cover_v5_ad(
        self,
    ) -> bilibili.app.card.v1.single_pb2.SmallCoverV5Ad:
        """"""
    def __init__(
        self,
        *,
        small_cover_v5: bilibili.app.card.v1.single_pb2.SmallCoverV5
        | None = ...,
        large_cover_v1: bilibili.app.card.v1.single_pb2.LargeCoverV1
        | None = ...,
        three_item_all_v2: bilibili.app.card.v1.single_pb2.ThreeItemAllV2
        | None = ...,
        three_item_v1: bilibili.app.card.v1.single_pb2.ThreeItemV1
        | None = ...,
        hot_topic: bilibili.app.card.v1.single_pb2.HotTopic | None = ...,
        three_item_h_v5: bilibili.app.card.v1.single_pb2.DynamicHot
        | None = ...,
        middle_cover_v3: bilibili.app.card.v1.single_pb2.MiddleCoverV3
        | None = ...,
        large_cover_v4: bilibili.app.card.v1.single_pb2.LargeCoverV4
        | None = ...,
        popular_top_entrance: bilibili.app.card.v1.single_pb2.PopularTopEntrance
        | None = ...,
        rcmd_one_item: bilibili.app.card.v1.single_pb2.RcmdOneItem
        | None = ...,
        small_cover_v5_ad: bilibili.app.card.v1.single_pb2.SmallCoverV5Ad
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
