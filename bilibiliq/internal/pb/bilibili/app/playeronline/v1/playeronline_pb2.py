...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'bilibili.app.playeronline.v1.playeronline_pb2', globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    _NOREPLY._serialized_start = 81
    _NOREPLY._serialized_end = 90
    _PLAYERONLINEREPLY._serialized_start = 93
    _PLAYERONLINEREPLY._serialized_end = 256
    _PLAYERONLINEREQ._serialized_start = 258
    _PLAYERONLINEREQ._serialized_end = 320
    _PREMIEREINFOREPLY._serialized_start = 322
    _PREMIEREINFOREPLY._serialized_end = 411
    _PREMIEREINFOREQ._serialized_start = 413
    _PREMIEREINFOREQ._serialized_end = 443
    _REPORTWATCHREQ._serialized_start = 445
    _REPORTWATCHREQ._serialized_end = 502
    _PLAYERONLINE._serialized_start = 505
    _PLAYERONLINE._serialized_end = 843
