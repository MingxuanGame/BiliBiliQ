...
class _PrivacyConfigStateEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _PrivacyConfigState.ValueType
    ],
    builtins.type,
):
...
class PrivacyConfigState(
    _PrivacyConfigState, metaclass=_PrivacyConfigStateEnumTypeWrapper
):
    """隐私开关状态"""
...
class _PrivacyConfigTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _PrivacyConfigType.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class PrivacyConfigType(
    _PrivacyConfigType, metaclass=_PrivacyConfigTypeEnumTypeWrapper
):
    """隐私开关类型"""
...
class PrivacyConfigReply(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "privacy_config_item", b"privacy_config_item"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class SetPrivacyConfigRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "privacy_config_type", b"privacy_config_type", "state", b"state"
        ],
    ) -> None: ...
