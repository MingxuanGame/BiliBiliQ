...
class Item(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        children: collections.abc.Iterable[global___Item] | None = ...,
        relation: global___Relation | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "official_verify", b"official_verify", "relation", b"relation"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
