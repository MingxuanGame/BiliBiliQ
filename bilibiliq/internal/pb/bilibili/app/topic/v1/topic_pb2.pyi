...
class _TopicCardTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _TopicCardType.ValueType
    ],
    builtins.type,
):
...
class _TopicDetailsExtModeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _TopicDetailsExtMode.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class TopicDetailsExtMode(
    _TopicDetailsExtMode, metaclass=_TopicDetailsExtModeEnumTypeWrapper
):
    """"""
...
class DetailsTopInfo(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"has_create_jurisdiction",
            "head_img_backcolor",
            b"head_img_backcolor",
            "head_img_url",
            b"head_img_url",
            "mission_page_show_type",
            b"mission_page_show_type",
            "mission_text",
            b"mission_text",
            "mission_url",
            b"mission_url",
...
class FunctionalCard(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "game_card", b"game_card", "traffic_card", b"traffic_card"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class OperationCard(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "card", b"card", "large_cover_inline", b"large_cover_inline"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    ) -> typing_extensions.Literal["large_cover_inline"] | None: ...
...
class OperationContent(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "operation_card", b"operation_card"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class PubLayer(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal["button_meta", b"button_meta"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class SortContent(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "sort_by", b"sort_by", "sort_name", b"sort_name"
        ],
    ) -> None: ...
...
class TimeLineResource(google.protobuf.message.Message):
    ...
    """"""
    @property
    def time_line_events(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___TimeLineEvents
    ]:
        """"""
    ...
    def __init__(
        ...
        *,
        ...
        time_line_title: builtins.str = ...,
        time_line_events: (
            collections.abc.Iterable[global___TimeLineEvents] | None
        ) = ...,
        has_more: builtins.bool = ...,
    ) -> None: ...
    def ClearField(
...
class TopicActivities(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        activity: (
            collections.abc.Iterable[global___TopicActivity] | None
        ) = ...,
        act_list_title: builtins.str = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "act_list_title", b"act_list_title", "activity", b"activity"
        ],
    ) -> None: ...
...
class TopicCapsule(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "icon_url", b"icon_url", "jump_url", b"jump_url", "name", b"name"
        ],
    ) -> None: ...
...
class TopicCardItem(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            ...
            "ford_card_item",
            b"ford_card_item",
            "video_small_card_item",
            b"video_small_card_item",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class TopicCardList(google.protobuf.message.Message):
    ...
    @property
    def topic_card_items(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___TopicCardItem
    ]:
        """"""
    offset: builtins.str
    """"""
    ...
    def __init__(
        ...
        *,
        topic_card_items: (
            collections.abc.Iterable[global___TopicCardItem] | None
        ) = ...,
        offset: builtins.str = ...,
        has_more: builtins.bool = ...,
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "topic_sort_by_conf", b"topic_sort_by_conf"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class TopicDetailsAllReply(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"pub_layer",
            "time_line_resource",
            b"time_line_resource",
            "topic_activities",
            b"topic_activities",
            "topic_card_list",
            b"topic_card_list",
            "topic_server_config",
            b"topic_server_config",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class TopicDetailsAllReq(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            "source",
            b"source",
            "topic_details_ext_mode",
            b"topic_details_ext_mode",
            "topic_id",
            b"topic_id",
        ],
    ) -> None: ...
...
class TopicDetailsFoldReply(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "topic_card_list", b"topic_card_list"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "fold_count", b"fold_count", "topic_card_list", b"topic_card_list"
        ],
    ) -> None: ...
...
class TopicServerConfig(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "pub_events_hidden_timeout_threshold",
            b"pub_events_hidden_timeout_threshold",
            "pub_events_increase_threshold",
            b"pub_events_increase_threshold",
            "vert_online_refresh_time",
            b"vert_online_refresh_time",
        ],
    ) -> None: ...
...
class TopicSetHeadInfo(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["topic_set", b"topic_set"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class TopicSetSortCfg(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        default_sort_by: builtins.int = ...,
        all_sort_by: (
            collections.abc.Iterable[global___SortContent] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class TopicThreePoint(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "dyn_three_point_items", b"dyn_three_point_items"
        ],
    ) -> None: ...
...
class VideoSmallCardItem(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "video_card_base", b"video_card_base"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            ...
            "card_stat_text2",
            b"card_stat_text2",
            "cover_left_badge_text",
            b"cover_left_badge_text",
            "video_card_base",
            b"video_card_base",
        ],
    ) -> None: ...
