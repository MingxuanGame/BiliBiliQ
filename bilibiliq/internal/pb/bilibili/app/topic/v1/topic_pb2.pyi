...
class TimeLineResource(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        time_line_id: builtins.int = ...,
        time_line_title: builtins.str = ...,
        time_line_events: collections.abc.Iterable[global___TimeLineEvents]
        | None = ...,
        has_more: builtins.bool = ...,
    ) -> None: ...
    def ClearField(
...
class TopicActivities(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        activity: collections.abc.Iterable[global___TopicActivity]
        | None = ...,
        act_list_title: builtins.str = ...,
    ) -> None: ...
    def ClearField(
...
class TopicCardItem(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        type: builtins.int = ...,
        dynamic_item: bilibili.app.dynamic.v2.dynamic_pb2.DynamicItem
        | None = ...,
...
class TopicCardList(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        topic_card_items: collections.abc.Iterable[global___TopicCardItem]
        | None = ...,
        offset: builtins.str = ...,
        has_more: builtins.bool = ...,
...
class TopicSetSortCfg(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        default_sort_by: builtins.int = ...,
        all_sort_by: collections.abc.Iterable[global___SortContent]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class TopicThreePoint(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        dyn_three_point_items: collections.abc.Iterable[
            global___ThreePointItem
        ]
        | None = ...,
    ) -> None: ...
