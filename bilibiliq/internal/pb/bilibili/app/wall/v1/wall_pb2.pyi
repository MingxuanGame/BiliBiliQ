...
class RulesInfo(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["rulesInfo", b"rulesInfo"]
    ) -> None: ...
...
class RulesReply(google.protobuf.message.Message):
    ...
    def rulesInfo(
        ...
        builtins.str, global___RulesInfo
    ]:
        """各ISP的免流规则信息组
        ISP如: cu ct cm
        """
    ...
    def __init__(
        self,
        *,
        rulesInfo: collections.abc.Mapping[builtins.str, global___RulesInfo]
        | None = ...,
        hash_value: builtins.str = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "hash_value", b"hash_value", "rulesInfo", b"rulesInfo"
        ],
    ) -> None: ...
