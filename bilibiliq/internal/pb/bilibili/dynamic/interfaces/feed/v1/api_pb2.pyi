...
class _DynamicButtonClickBizTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _DynamicButtonClickBizType.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    DYNAMIC_BUTTON_CLICK_BIZ_TYPE_NONE: (
        _DynamicButtonClickBizType.ValueType
    )  # 0
    """"""
    DYNAMIC_BUTTON_CLICK_BIZ_TYPE_LIVE: (
        _DynamicButtonClickBizType.ValueType
    )  # 1
    """"""
...
class DynamicButtonClickBizType(
    _DynamicButtonClickBizType,
    metaclass=_DynamicButtonClickBizTypeEnumTypeWrapper,
):
    """"""
...
class _ReserveButtonModeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _ReserveButtonMode.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class ReserveButtonMode(
    _ReserveButtonMode, metaclass=_ReserveButtonModeEnumTypeWrapper
):
    """"""
...
class _ReserveButtonStatusEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _ReserveButtonStatus.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class ReserveButtonStatus(
    _ReserveButtonStatus, metaclass=_ReserveButtonStatusEnumTypeWrapper
):
    """"""
...
class CreateDynReq(google.protobuf.message.Message):
    ...
    def pics(
        ...
        bilibili.dynamic.common.dynamic_pb2.CreatePic
    ]:
        """图片内容"""
    ...
    def attach_card(
        self,
    ) -> bilibili.dynamic.common.dynamic_pb2.CreateAttachCard:
        """动态附加大卡"""
    ...
    def __init__(
        ...
        *,
        ...
        content: (
            bilibili.dynamic.common.dynamic_pb2.CreateContent | None
        ) = ...,
        scene: bilibili.dynamic.common.dynamic_pb2.CreateScene.ValueType = ...,
        pics: (
        ...
        repost_src: (
            bilibili.dynamic.common.dynamic_pb2.DynIdentity | None
        ) = ...,
        ...
        attach_card: (
            bilibili.dynamic.common.dynamic_pb2.CreateAttachCard | None
        ) = ...,
...
class CreateInitCheckReq(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        repost: (
            bilibili.dynamic.common.dynamic_pb2.RepostInitCheck | None
        ) = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "meta", b"meta", "repost", b"repost"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "meta", b"meta", "repost", b"repost", "scene", b"scene"
        ],
    ) -> None: ...
...
class CreatePageInfosReq(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["topic_id", b"topic_id"]
    ) -> None: ...
...
class CreatePageTopicInfo(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "topic_id", b"topic_id", "topic_name", b"topic_name"
        ],
    ) -> None: ...
...
class HotSearchRsp(google.protobuf.message.Message):
    ...
    class Item(google.protobuf.message.Message):
        ...
        def ClearField(
            self, field_name: typing_extensions.Literal["words", b"words"]
        ) -> None: ...
    ...
    def __init__(
        ...
        *,
        items: (
            collections.abc.Iterable[global___HotSearchRsp.Item] | None
        ) = ...,
        version: builtins.str = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "items", b"items", "version", b"version"
        ],
    ) -> None: ...
...
class SuggestReq(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["s", b"s", "type", b"type"]
    ) -> None: ...
...
class SuggestRsp(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "list", b"list", "track_id", b"track_id", "version", b"version"
        ],
    ) -> None: ...
