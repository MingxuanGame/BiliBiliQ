...
class CreateDynReq(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        content: bilibili.dynamic.common.dynamic_pb2.CreateContent
        | None = ...,
        scene: bilibili.dynamic.common.dynamic_pb2.CreateScene.ValueType = ...,
        pics: collections.abc.Iterable[
            bilibili.dynamic.common.dynamic_pb2.CreatePic
        ]
        | None = ...,
        repost_src: bilibili.dynamic.common.dynamic_pb2.DynIdentity
        | None = ...,
        ...
        attach_card: bilibili.dynamic.common.dynamic_pb2.CreateAttachCard
        | None = ...,
...
class CreateInitCheckReq(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        repost: bilibili.dynamic.common.dynamic_pb2.RepostInitCheck
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class HotSearchRsp(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        items: collections.abc.Iterable[global___HotSearchRsp.Item]
        | None = ...,
        version: builtins.str = ...,
    ) -> None: ...
    def ClearField(
