...
class BanUser(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            "limit", b"limit", "mode", b"mode", "time", b"time", "uid", b"uid"
        ],
    ) -> None: ...
...
class ReqOpBlacklist(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["ban_users", b"ban_users"]
    ) -> None: ...
...
class RspOpBlacklist(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["failed_users", b"failed_users"],
    ) -> None: ...
