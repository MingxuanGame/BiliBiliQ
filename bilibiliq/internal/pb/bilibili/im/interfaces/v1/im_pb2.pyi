...
class ReqGetSpecificSessions(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        talker_sessions: (
            collections.abc.Iterable[global___SimpleSession] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class ReqSessionDetails(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        sess_ids: (
            collections.abc.Iterable[global___ReqSessionDetail] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
...
class RspGetMsg(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        msg: (
            collections.abc.Iterable[bilibili.im.type.im_pb2.Msg] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["msg", b"msg"]
...
class RspRelationSync(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        full: builtins.int = ...,
        relation_logs: (
            collections.abc.Iterable[bilibili.im.type.im_pb2.RelationLog]
            | None
        ) = ...,
        friend_list: (
            collections.abc.Iterable[bilibili.im.type.im_pb2.FriendRelation]
            | None
        ) = ...,
        server_relation_oplog_seqno: builtins.int = ...,
        group_list: (
            collections.abc.Iterable[bilibili.im.type.im_pb2.GroupRelation]
            | None
        ) = ...,
    ) -> None: ...
    def ClearField(
...
class RspSessionDetails(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        sess_infos: (
            collections.abc.Iterable[bilibili.im.type.im_pb2.SessionInfo]
            | None
        ) = ...,
    ) -> None: ...
    def ClearField(
...
class RspShareList(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        session_list: (
            collections.abc.Iterable[global___ShareSessionInfo] | None
        ) = ...,
        IsAddressListEmpty: builtins.int = ...,
    ) -> None: ...
    def ClearField(
    ...
    def __init__(
        ...
        *,
        ...
        sys_msg_interface_last_msg: (
            global___SysMsgInterfaceLastMsgRsp | None
        ) = ...,
        total_unread: builtins.int = ...,
    ) -> None: ...
    def HasField(
