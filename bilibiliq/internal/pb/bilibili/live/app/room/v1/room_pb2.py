...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'bilibili.live.app.room.v1.room_pb2', globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    _GETSTUDIOLISTREQ._serialized_start = 67
    _GETSTUDIOLISTREQ._serialized_end = 102
    _GETSTUDIOLISTRESP._serialized_start = 105
    _GETSTUDIOLISTRESP._serialized_end = 623
    _GETSTUDIOLISTRESP_PENDANTS._serialized_start = 223
    _GETSTUDIOLISTRESP_PENDANTS._serialized_end = 371
    _GETSTUDIOLISTRESP_PENDANT._serialized_start = 373
