...
class LivePlayInfo(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        current_qn: builtins.int = ...,
        quality_description: (
            collections.abc.Iterable[global___QualityDescription] | None
        ) = ...,
        durl: collections.abc.Iterable[global___ResponseDataUrl] | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class LivePlayViewReply(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        room_info: global___RoomInfo | None = ...,
        play_info: global___LivePlayInfo | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "play_info", b"play_info", "room_info", b"room_info"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ProjectReq(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            "spmid",
            b"spmid",
            "use_new_project_code",
            b"use_new_project_code",
        ],
    ) -> None: ...
...
class QualityDescription(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["desc", b"desc", "qn", b"qn"],
    ) -> None: ...
...
class ResponseDataUrl(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "ptag", b"ptag", "stream_type", b"stream_type", "url", b"url"
        ],
    ) -> None: ...
...
class RoomInfo(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        room_id: builtins.int = ...,
        uid: builtins.int = ...,
        status: global___RoomStatusInfo | None = ...,
        show: global___RoomShowInfo | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "show", b"show", "status", b"status"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
