...
class PlayViewReply(BaseModel):
    ...
    video_info: (
        bilibiliq.internal.pb.bilibili.app.playurl.v1.playurl_pb2_model.VideoInfo
    )
    """视频流信息"""
...
class PlayViewReq(BaseModel):
    ...
    """青少年模式"""
    prefer_codec_type: (
        bilibiliq.internal.pb.bilibili.app.playurl.v1.playurl_pb2_model.CodeType
    )
    """视频编码"""
    is_preview: builtins.bool
    """是否强制请求预览视频"""
...
class ProjectReply(BaseModel):
    ...
    project: (
        bilibiliq.internal.pb.bilibili.app.playurl.v1.playurl_pb2_model.PlayURLReply
    )
    """Ellipsis"""
