...
class CommandDmsOttReply(google.protobuf.message.Message):
    ...
    def command_dms_ott(
        ...
        global___CommandDmOtt
    ]:
        """"""
    def __init__(
        self,
        *,
        command_dms_ott: collections.abc.Iterable[global___CommandDmOtt]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "command_dms_ott", b"command_dms_ott"
        ],
    ) -> None: ...
...
class TvViewProgressReply(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "chronos", b"chronos", "video_guide", b"video_guide"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class VideoGuide(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["command_dms", b"command_dms"],
    ) -> None: ...
