...
class _ActivitySeasonStatusEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _ActivitySeasonStatus.ValueType
    ],
    builtins.type,
):
...
class ActivitySeasonStatus(
    _ActivitySeasonStatus, metaclass=_ActivitySeasonStatusEnumTypeWrapper
):
    """"""
...
class _OrderTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _OrderType.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _ReplyEmoteMetaSizeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _ReplyEmoteMetaSize.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class ReplyEmoteMetaSize(
    _ReplyEmoteMetaSize, metaclass=_ReplyEmoteMetaSizeEnumTypeWrapper
):
    """"""
...
class ActivityArchiveReq(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "activity_key", b"activity_key", "aid", b"aid", "bvid", b"bvid"
        ],
    ) -> None: ...
...
class ActivityEpisode(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "author", b"author", "rights", b"rights"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ActivityGame(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        iframes: collections.abc.Iterable[global___ActivityGameIframe]
        | None = ...,
        disclaimer: builtins.str = ...,
        disclaimer_url: builtins.str = ...,
    ) -> None: ...
...
class ActivityLive(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "operation_relate", b"operation_relate"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ActivityLiveTimeInfoReq(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["activity_key", b"activity_key"],
    ) -> None: ...
...
class ActivitySeasonSection(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        title: builtins.str = ...,
        type: builtins.int = ...,
        episodes: collections.abc.Iterable[global___ActivityEpisode]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class ActivitySubscribe(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            ...
            "param",
            b"param",
            "reserve_activity_param",
            b"reserve_activity_param",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        ...
        "reserve_activity_param", "fav_season_param", "jump_URL_param"
    ] | None: ...
...
class ActivityTheme(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        player_loading_img: builtins.str = ...,
        share_img: builtins.str = ...,
        kv_color: collections.abc.Mapping[builtins.str, builtins.str]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            ...
            b"combo_like_img",
            "decorations2233_img",
            b"decorations2233_img",
            "default_element_color",
            b"default_element_color",
            "hover_element_color",
            b"hover_element_color",
            "info_font_color",
            b"info_font_color",
            "kv_color",
            b"kv_color",
            "like_animation_img",
            b"like_animation_img",
            "live_list_location_img",
            b"live_list_location_img",
            "live_list_location_img_active",
            b"live_list_location_img_active",
            "loading_bg_color",
            b"loading_bg_color",
            "main_banner_bg_img",
            b"main_banner_bg_img",
            "main_banner_title_img",
            b"main_banner_title_img",
            "mask_bg_color",
            b"mask_bg_color",
            "operated_bg_color",
            b"operated_bg_color",
...
class ActivityView(google.protobuf.message.Message):
    ...
    def sections(
        ...
        global___ActivitySeasonSection
    ]:
        """"""
    def __init__(
        self,
        *,
        ...
        right_relate: global___OperationRelate | None = ...,
        bottom_relate: global___OperationRelate | None = ...,
        sections: collections.abc.Iterable[global___ActivitySeasonSection]
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class Author(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "face", b"face", "mid", b"mid", "name", b"name"
        ],
    ) -> None: ...
...
class DescV2(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "biz_id", b"biz_id", "raw_text", b"raw_text", "type", b"type"
        ],
    ) -> None: ...
...
class HotReply(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["page", b"page"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "page", b"page", "replies", b"replies"
        ],
    ) -> None: ...
...
class JumpURLParam(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["jump_url", b"jump_url"]
    ) -> None: ...
...
class OfficialInfo(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "desc", b"desc", "role", b"role", "title", b"title"
        ],
    ) -> None: ...
...
class Relate(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["arc", b"arc"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "arc", b"arc", "bvid", b"bvid", "season_type", b"season_type"
        ],
    ) -> None: ...
...
class Relation(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "attribute", b"attribute", "special", b"special"
        ],
    ) -> None: ...
...
class ReplyContent(google.protobuf.message.Message):
    ...
    def emote(
        ...
        builtins.str, global___ReplyEmote
    ]:
        """"""
    def __init__(
        self,
        *,
        ...
        device: builtins.str = ...,
        version: builtins.str = ...,
        members: collections.abc.Iterable[global___ReplyMemberInfo]
        | None = ...,
        emote: collections.abc.Mapping[builtins.str, global___ReplyEmote]
        | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["vote", b"vote"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class ReplyLabel(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            "text_color",
            b"text_color",
            "text_color_night_mode",
            b"text_color_night_mode",
        ],
    ) -> None: ...
...
class ReplyMember(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "fans_detail", b"fans_detail", "info", b"info"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class SeasonEpisode(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "arc", b"arc", "badge_style", b"badge_style", "page", b"page"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class SeasonSection(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        title: builtins.str = ...,
        type: builtins.int = ...,
        episodes: collections.abc.Iterable[global___SeasonEpisode]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class Staff(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "official", b"official", "relation", b"relation", "vip", b"vip"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class Subtitle(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "allow_submit", b"allow_submit", "list", b"list"
        ],
    ) -> None: ...
...
class Tag(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["tag_count", b"tag_count"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class TagCount(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "atten", b"atten", "use", b"use", "view", b"view"
        ],
    ) -> None: ...
...
class UGCPayAsset(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        price: builtins.int = ...,
        platform_price: collections.abc.Mapping[builtins.str, builtins.int]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "platform_price", b"platform_price", "price", b"price"
        ],
    ) -> None: ...
...
class UGCSeason(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        sign_state: builtins.int = ...,
        attribute: builtins.int = ...,
        sections: collections.abc.Iterable[global___SeasonSection]
        | None = ...,
...
class ViewDetailReply(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "card", b"card", "reply", b"reply", "view", b"view"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
