...
class ActivityGame(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        iframes: (
            collections.abc.Iterable[global___ActivityGameIframe] | None
        ) = ...,
        disclaimer: builtins.str = ...,
        disclaimer_url: builtins.str = ...,
    ) -> None: ...
...
class ActivitySeasonSection(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        type: builtins.int = ...,
        episodes: (
            collections.abc.Iterable[global___ActivityEpisode] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class ActivityView(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        bottom_relate: global___OperationRelate | None = ...,
        sections: (
            collections.abc.Iterable[global___ActivitySeasonSection] | None
        ) = ...,
    ) -> None: ...
    def HasField(
        self,
...
class ReplyContent(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        version: builtins.str = ...,
        members: (
            collections.abc.Iterable[global___ReplyMemberInfo] | None
        ) = ...,
        emote: (
            collections.abc.Mapping[builtins.str, global___ReplyEmote] | None
        ) = ...,
    ) -> None: ...
    def HasField(
...
class SeasonSection(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        type: builtins.int = ...,
        episodes: (
            collections.abc.Iterable[global___SeasonEpisode] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self,
...
class UGCSeason(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        attribute: builtins.int = ...,
        sections: (
            collections.abc.Iterable[global___SeasonSection] | None
        ) = ...,
